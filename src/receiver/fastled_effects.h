...
/* **************************   see https://www.tweaking4all.com/hardware/arduino/adruino-led-strip-effects/#FastLEDFramework   */ 
...
void show_battery_level(int batteryLevel){
  fill_solid(leds, NUM_LEDS, CRGB::Black);  
  if(batteryLevel >= 80){
    setPixel(1,0,255,0);    //green
  }
  else if (batteryLevel >40)
  {
    setPixel(1,255,255,0);    //yellow
  }
  else{
